...
model_root = '/home/alya/work/sketch/models/'
...
for character_name in characters:
    ...
    for animation_i, animation_file in enumerate(os.listdir(animation_dir)[512:513]):
        if character_name == 'xbot':
            animation_file = 'Spinning.fbx'
        ...
        for frame in range(scene.frame_start, scene.frame_end, 10):
            ...
            for camera_num, camera in enumerate(cameras):
                ...
                f = open(root + f'renders/' + character_name + f'/skeleton/{animation_i}_{camera_num}_{frame}_{global_cnt}', 'w')
                ...
                file = os.path.join(root + f'renders/' + character_name + '/', f'{animation_i}_{camera_num}_{frame}_{global_cnt}')
                global_cnt += 1
